...
export interface ProjectLink {
  url: string;
  kind: LinkKind;
  /** When true, render as plain text with a "down" annotation instead of a link. */
  down?: boolean;
}
...
export interface Project {
  ...
  description: string;
  links: ProjectLink[];
  /** Optional path under /public, e.g. "projects/cardforest.png" */
  image?: string;
}
...
export const projects: Project[] = [
  {
    ...
    links: [{ url: 'http://www.cardforest.com', kind: 'website', down: true }],
  },
  {
  ...
  },
  {
    ...
    links: [
      { url: 'http://onlinelibrary.wiley.com/doi/10.1002/spe.2226/abstract', kind: 'paper' },
  ...
  },
  {
    ...
    links: [{ url: 'http://www.isradoc.com', kind: 'website', down: true }],
  },
  {
